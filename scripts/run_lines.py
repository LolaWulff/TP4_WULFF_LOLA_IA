...
from hough_lines.hough_lines import hough_space, find_peaks
...
def main():
    ...
    parser.add_argument("--k", type=int, default=5, help="Máx. picos")
    ...
    print("     (TODO) Próximo commit: dibujar rectas en la imagen original.")
